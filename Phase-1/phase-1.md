...
Within this project I have connected my Ubunutu Server with my host laptop via a shared internal network facilitated and running through Oracle Virtual Box and its host only adapter, this is so that there is a secure private communication between the two. Then you can have administrative access through the Safe Shell (SSH) 
